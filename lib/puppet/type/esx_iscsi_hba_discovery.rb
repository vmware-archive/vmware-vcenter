...
Puppet::Type.newtype(:esx_iscsi_hba_discovery) do
  @doc = "Manages iscsi discovery properties"
  ...
  newparam(:iscsi_hba_device) do
    desc "The device of the Internet SCSI HBA adapter."
  end

  map = PuppetX::VMware::Mapper.new_map('HostInternetScsiHbaDiscoveryPropertiesMap')
